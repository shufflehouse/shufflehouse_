(function() {
  ...
  const section = document.querySelector('html.is-account .userInformationForm section:nth-of-type(2)');
  if (!section) return;
  ...
  const profileLabelBlock = section.querySelector('label[for="avatarImage"]')?.closest('div');
